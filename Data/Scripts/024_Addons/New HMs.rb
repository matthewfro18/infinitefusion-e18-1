...
def canSurfHere?()
  ...
  #facingTile = Kernel.pbFacingTileRegular($game_player.direction)
  #facingTilePassable = $game_map.passable?(facingTile[0],facingTile[1],facingTile[2])

  return pbIsSurfableTag?(terrain) && !$PokemonGlobal.surfing && 
